...
document.write(
  ...
  '    <h1><span id="widgetTitle">Bierzeame</span> ' +
...
for(i=1; i<=maxLength; i++){
  document.write(
    ...
    '    <a href="#list" data-role="button" data-icon="grid" data-back="true">Inicio</a>' +
    '    <h1 id="articleHeader' + i + '">&nbsp;</h1>' +
    '    <a href="#" id="openButton' + i + '" data-role="button" data-icon="plus"' +
    '      class="ui-btn-right" rel="external">Ampliar Noticia</a>' +
    '  </div>' +
    '  <div data-role="content">' +
...
/* JSONP */
$(function(){
  getOnlineFeed('http://www.bierzeame.com/rss/category/published/');
});
/* functions */
